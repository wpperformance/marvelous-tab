...
function Edit(props) {
  ...
  const innerBlocks = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_2__.useSelect)(select => select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.store).getBlock(clientId).innerBlocks);
  // on enter
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (innerBlocks.length > 0) {
      setAttributes({
        showID: innerBlocks[0].clientId
      });
    }
  }, []);
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("div", {
      ...
      children: innerBlocks.map(block => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)("button", {
        onClick: () => setAttributes({
          showID: block.clientId
        }),
        className: block.clientId === attributes.showID ? 'tab-is-active' : '',
        children: block.attributes.title
      }))
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"goodmotion/tab-group","version":"0.1.0","title":"Marvelous Tab Group","category":"widgets","icon":"grid-view","description":"Group for tab","example":{},"attributes":{"showID":{"type":"string"}},"supports":{"html":false,"align":true,"alignWide":true,"interactivity":true},"textdomain":"marvelous-tab","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScriptModule":"file:./view.js"}');
